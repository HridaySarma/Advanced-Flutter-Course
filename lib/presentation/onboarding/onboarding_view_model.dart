...
class OnBoardingViewModel extends BaseViewModel
  ...
  List<SliderObject> _getSliderData() => [
    SliderObject(AppStrings.onBoardingtitle1,
        AppStrings.onBordingSubtitle1, ImageAssets.onBoardingLogo1),
    SliderObject(AppStrings.onBoardingtitle2,
        AppStrings.onBordingSubtitle2, ImageAssets.onBoardingLogo2),
    SliderObject(AppStrings.onBoardingtitle3,
        AppStrings.onBordingSubtitle3, ImageAssets.onBoardingLogo3),
    SliderObject(AppStrings.onBoardingtitle4,
        AppStrings.onBordingSubtitle4, ImageAssets.onBoardingLogo4)
  ];
